...
extern int autoTeamBalanceActive;
extern int shuffleTeamsInProgress;
extern int lastCallVoteTime;
extern int lastMapRotationTime;
...
typedef struct {
	...
	int			voted;
	int			teamVoted;
	int timeSpent;   // New field to track the time spent on the server
	int frags;
	qboolean	inGame;
	int joinTime;
} clientPersistant_t;
